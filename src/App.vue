<template>
  <div id="app">
    <!-- {{messages.name}}
    <span v-bind:title="message">啦啦啦阿联</span>
    <div v-for="(itme,index) in arr" :key="index">{{itme}}</div>
    <div v-if="false">11111111</div>
    <div v-else-if="true">222222</div>
    <div v-else>3333333</div>
    <div v-on:click="test">点我</div>
